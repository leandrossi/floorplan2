...
class PipelineRunner:
    def _run_roboflow(self, image_path: Path, output_dir: Path) -> Path:
        ...
        if proc.returncode != 0:
            err = (proc.stderr or proc.stdout or "").strip() or "Roboflow falló sin mensaje."
    ...
    def run_to_step04(
        ...
        _progress(0.05, "Subiendo plano para interpretación automática...")
        ...
        _progress(0.18, "Detectando muros y aperturas...")
        run_step01(json_path, workspace.step01_dir)

        _progress(0.40, "Separando interior y exterior...")
        run_step02(
        ...
        _progress(0.62, "Asignando ambientes detectados...")
        run_step03(
        ...
        _progress(0.84, "Preparando la revisión visual...")
        run_step04(
            workspace.step02_dir / "space_classified.npy",
        ...
        _progress(1.0, "Listo para revisar el plano.")
        return {
    ...
    def run_step05(
        ...
        *,
        ...
        _progress(0.20, "Armando la propuesta sobre tu plano...")
        run_step05(
            workspace.step04_dir,
            DEFAULT_CONFIG,
            out_dir,
        ...
        _progress(1.0, "Propuesta generada.")
        return {
