...
This document explains every type in `src/acala_engine/model.py`. Use it for daily reading or export to PDF. Section headings match the code symbols so you can jump between doc and code quickly.
